...
with col1:
    st.title(body='Error Code Search')

    st.write('''For now this is only good for whirlpool front load and topload washers.
             Its still a work in progress but you get the basics.''')
with col2:
    st.image(image)
st.write('---')
